...
namespace FieldDataAnalyzer
{
	public class Graph
	{
		...
		private void GetNodes()
		{
			...
			nodes.Add(new Node {Id = sborNode.First().gather_point_id, Name = sborNode.First().name, NextNode = null});
			endNode = nodes[0];
		...
		{
			foreach (var _well in dbEntities.wells)
			{
	...
	public class Node
	{
		...
		public double? P = null, T = null, G = null;
		public PointF point;
		public double[] P_, G_, T_, a, b;
